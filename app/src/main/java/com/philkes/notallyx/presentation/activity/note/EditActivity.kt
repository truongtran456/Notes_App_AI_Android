...
abstract class EditActivity(private val type: Type) :
    ...
    protected open fun initBottomMenu() {
        ...
        // AI FAB thay b?ng nút inline trên header, không t?o FAB n?i n?a
        setupJellyFab()
    }
    ...
    /**
     * Hi?n th? canvas và bottom bar ngay trong EditActivity Toolbar gi? nguyên, ch? show canvas và
    ...
    /** Animation cho canvas và bottom bar khi m? drawing mode */
