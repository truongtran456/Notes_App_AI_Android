...
import com.starnest.common.databinding.FragmentDeleteDialogBinding
import com.starnest.common.extension.setTextColorGradient
...
@AndroidEntryPoint
class DeleteDialogFragment : BaseDialogFragment<FragmentDeleteDialogBinding, BaseViewModel>(
    BaseViewModel::class
) {
    ...
    override fun layoutId(): Int = com.starnest.common.R.layout.fragment_delete_dialog
    ...
    private fun setupView() {
        ...
        binding.apply {
            ...
            val background = if (isDeleteDialog) {
                ContextCompat.getDrawable(
                    requireContext(),
                    com.starnest.common.R.drawable.bg_delete_setting
                )
            } else {
                ContextCompat.getDrawable(
                    requireContext(),
                    R.drawable.bg_button_restore
                )
            }

            val discountColors = intArrayOf(
                "#FFC340".color,
                "#FF8400".color
            )

            tvPositive.background = background
            tvNegative.setTextColorGradient(discountColors)
