package com.starnest.common.ui.view.sliderview
...
import com.starnest.core.extension.dp
...
//        style = Paint.Style.STROKE
    ...
    private fun restrictPointerX(pointerX: Float): Float {
        return if (pointerX < trackMovableArea.left) {
            trackMovableArea.left
        } else if (pointerX > trackMovableArea.right) {
            trackMovableArea.right
        } else {
            pointerX
        }
    }
